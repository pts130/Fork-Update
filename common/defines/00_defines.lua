...
NNavy = {
	...
	AMPHIBIOUS_INVADE_MOVEMENT_COST = 24.0, 						-- total progress cost of movement while amphibious invading
	AMPHIBIOUS_INVADE_ATTACK_LOW = 1.5, 							-- low and high cap of attack modifier scale. Scale interpolated by invasion progress.
	AMPHIBIOUS_INVADE_ATTACK_HIGH = 0.9,
	...
	AGGRESION_MULTIPLIER_FOR_COMBAT = 2.0,				-- ships are more aggresive in combat
	...
	SPOTTING_SPEED_MULT_FOR_RUNNING_AWAY = 0.2,						-- task forces that does not want to engage will reduce enemy spotting rate every hour by speed diff mult this ratio
...
NAI = {
	...
	PLAN_VALUE_TO_EXECUTE = -3.0				-- AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
	...
	INVASION_COASTAL_PROVS_PER_ORDER = 6,				-- AI will consider one extra invasion per number of provinces stated here (num orders = total coast / this)
	...
	MAX_DISTANCE_NALAV_INVASION = 8000.0,				-- AI is extremely unwilling to plan naval invasions above this naval distance limit.
	...
	MAX_UNITS_FACTOR_INVASION_ORDER = 4.0,				-- Factor for max number of units to assign to naval invasion orders
	DESIRED_UNITS_FACTOR_INVASION_ORDER = 4.0,			-- Factor for desired number of units to assign to naval invasion orders
	MIN_UNITS_FACTOR_INVASION_ORDER = 1.5,				-- Factor for min number of units to assign to naval invasion orders
	...
	INVASION_DISTANCE_RANDOMNESS = 8000,				-- This higher the value, the more unpredictable the invasions. Compares to actual map distance in pixels.
	...
	MAX_UNIT_RATIO_FOR_INVASIONS = 100.0,						-- countries won't use armies more than this ratio of total units for invasions
	...
	MIN_NUM_CONQUERED_PROVINCES_TO_DEPRIO_NAVAL_INVADED_FRONTS = 450,	-- if you conquer this amount of provinces after a naval invasion, it will lose its prio status and will act as a regular front
	...
	MIN_INVASION_PLAN_VALUE_TO_EXECUTE = 0.0,				-- ai will only activate invasions if it is above this
	MAX_INVASION_SIZE = 100,								-- max invasion group size
